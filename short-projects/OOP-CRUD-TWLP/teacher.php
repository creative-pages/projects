...
<div class="col-sm-5">
	<h4><a href="index.php">Create New For Student</a></h4>
	...
	<table class="table table-bordered table-striped">
		...
		<tr>
			...
			<td>
				...
				<a href="teacher.php?action=delete&id=<?php echo $value['id']; ?>" onClick='return confirm("Are you sure to delete data?")'>Delete</a>
			</td>
		</tr>
		<?php
