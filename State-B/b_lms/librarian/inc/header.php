...
$librarian = mysqli_query($conn, "SELECT * FROM `librarian` WHERE `username` = '$librarian_username'");
$librarian_info = mysqli_fetch_assoc($librarian);
            ...
            <div class="rightside-header">
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        ...
                        <div class="user-info">
                            <span class="user-name"><?= $librarian_info['fname'] . ' ' . $librarian_info['lname']; ?></span>
