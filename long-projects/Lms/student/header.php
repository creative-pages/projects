...
$std_info = mysqli_query($dbconn, "SELECT * FROM `students` WHERE `id` = '$std_id'");
$std_infos = mysqli_fetch_assoc($std_info);
            ...
            <div class="leftside-header">
                <div class="logo">
                    <a href="index.php" class="on-click">
                        <h3 style="margin-left: 15px;">LMS</h3>
                    </a>
                </div>
            ...
            <div class="rightside-header">
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        ...
                        <div class="user-info">
                            <span class="user-name"><?php echo $std_infos['fname'] . ' ' . $std_infos['lname']; ?></span>
