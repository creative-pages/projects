...
if (isset($_POST['admin_login'])) {
    $login_err = $login->loginCheck($_POST);
}
                ...
                <div class="panel-content bg-scale-0">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <?php if (isset($login_err)) { echo '<div style="margin-top: 10px;" class="alert alert-warning">' . $login_err . '</div>'; } ?>
                        </div>
                        <div class="form-group">
                            <input type="submit" name="admin_login" class="btn btn-primary btn-block" value="Admin Login">
                        </div>
