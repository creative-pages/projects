		...
		<div class="col-sm-12 col-md-6 col-md-offset-3">
			...
			<div class="panel">
				<div class="panel-content">
					<div class="row">
						<div class="col-md-12">
							<form action="{{ route('update.category', $singleCat->id) }}" method="POST" class="form-horizontal">
								@csrf
								<h3 class="mb-lg text-center">Update Category</h3>
								<div class="form-group">
									<label for="category" class="col-sm-3 control-label">Category Name</label>
									<div class="col-sm-9">
										<input type="text" name="category_name" class="form-control" id="category" value="{{ $singleCat->category_name }}" placeholder="Category Name">
										@error('category_name')
